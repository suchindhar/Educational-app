...
class HomeScreen extends StatelessWidget {
  ...
  const HomeScreen({super.key, this.scholarName = 'Scholar'});
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: Consumer<GitHubContentService>(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          '${_greeting()},',
                          style: TextStyle(color: Colors.white60, fontSize: 13, fontWeight: FontWeight.w600, letterSpacing: 0.5),
                        ),
                        ...
                        const Text(
                          ...
                          style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w900, letterSpacing: -0.5, height: 1),
                        ),
                      ],
                    ),
                  ),
                  GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ProfileScreen(scholarName: scholarName))),
                    child: Container(
                      width: 56, height: 56,
                      ...
                      child: Center(
                        child: Text(
                          scholarName.isNotEmpty ? scholarName[0].toUpperCase() : 'S',
